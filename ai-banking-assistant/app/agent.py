...
def get_root_agent() -> LlmAgent:
    ...
    agent = LlmAgent(
        ...
        global_instruction=(
            f"""
            You are AI Banking Assistant, a customer facing helpful Multi Agent System.
...
_plugins = []
_project_id = os.environ.get("BQ_PROJECT_ID") or os.environ.get("GOOGLE_CLOUD_PROJECT")
...
if _project_id:
    try:
        ...
        _logger.info("BigQuery Agent Analytics plugin configured successfully.")
    except Exception as e:
        _logger.warning("Could not initialize BigQuery Analytics plugin: %s", e)
