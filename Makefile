.PHONY: install dev dev-backend dev-frontend identity-service customer-data-service bq-setup generate-data upload-data data-setup lint deploy-adk deploy-identity-service deploy-data-service
